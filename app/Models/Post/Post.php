...
class Post extends DefaultModel
{
    ...
    /**
     * Keep the accent-insensitive search columns in sync on every save,
     * whatever writes the post (actions, seeders, factories).
     */
    protected static function booted(): void
    {
        static::saving(function (Post $post): void {
            ...
            $post->search_title = $normalize($post->title);
            $post->search_content = $normalize(app(ExtractPostPlainTextAction::class)($post->content));
        });
    }
