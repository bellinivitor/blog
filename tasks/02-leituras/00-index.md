...
- [x] Editor de post: botão "Inserir leitura" busca uma leitura e transforma o trecho selecionado em link (sem seleção, insere o título).
- [x] Post publicado: referência vira link para a URL atual da leitura; leitura excluída vira texto simples.
- [x] Alterar o link de uma leitura atualiza os posts que a citam (cache do HTML invalidado).
...
- [x] [04 — Referência no post: renderização](04-referencia-renderizacao.md) · done
- [x] [05 — Referência no post: editor](05-referencia-editor.md) · done
